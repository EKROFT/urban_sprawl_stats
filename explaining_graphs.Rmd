...
plot1<-ggplot(data, aes(x=BD, y=LST_mean, color=Imp.)) +
  ...
  theme_classic()+
  scale_color_continuous(low="gray54", high="red")
...
![An example of an area with 0 buildings but close to 100% impervious cover](Site_3.png)
...
![Site 245 narrow](Site_245_narrow.png)
...
![Site 245 wide](Site_245_wide.png)
...
plot6<-ggplot(data, aes(x=Income, y=LST_mean, color=NDVImean)) +
  ...
  theme_classic()+
  scale_color_continuous(low="grey60", high="green")+
  geom_smooth(method=lm, color="black")+
...
![Effect of income on physical environment](diagram1.jpg)
...
![Site 86 (lowest LST value)](Site_86.png)
Site 86 (lowest LST value)
![Site 186 (highest LST value)](Site_186.png)
